(function ($) {
  ...
  function akasha_header_sticky($elem) {
    var $this = $elem;
    $this
      .on("akasha_header_sticky", function () {
        $this.each(function () {
  ...
  $(window).on("load", function () {
    ...
    if ($(".owl-slick .product-item").length) {
      akasha_hover_product_item(
        $(".akasha-products .owl-slick .row-item," + ".owl-slick .product-item")
      );
    }
